...
const nomor_hp_yang_ngirim = "+"
const nama_yang_ngirim = "Bass"
...
// yang ini biarin aja
let n = 0
const link_wa = `https://t.me/semutgenii`
nm.textContent = nama
...
const kata = [
  ...
  `Jaga kesehatan yaaa 🙃`,
  `Jangan lupa makan ya sama jaga kesehatan kamu dan jangan boros awas kalo boros tak gigit `,
  `Jangan lupa di makan 🍰 nya, walau virtual hehe`,
  `I wish you the best of everything in your life ${nama} cantik 🙌✨`
]
